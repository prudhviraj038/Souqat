...
public class AddProduct2Activity extends Activity {
    ...
    LinearLayout cat_ll,stock_ll,stock_pop,next1_ll,next2_ll,add_btn,save;
...
//            cat_tv.setText(products.title);
            ...
            for (int i = 0; i < products.groups.size(); i++) {
                for (int j = 0; j < products.groups.size(); j++) {
...
//                builder.setTitle(Settings.getword(AddProductActivity.this,"choose_levels"));
                ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(AddProduct2Activity.this, android.R.layout.simple_dropdown_item_1line, cat_title);
...
//                isimgchoosen=true;
    ...
    public void encodeImagetoString() {
        new AsyncTask<Void, Void, String>() {
            final ProgressDialog progressDialog = new ProgressDialog(AddProduct2Activity.this);
    ...
    private void get_level() {
        ...
        JsonArrayRequest jsObjRequest = new JsonArrayRequest(url, new Response.Listener<JSONArray>() {
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(AddProduct2Activity.this, "Server not connected", Toast.LENGTH_SHORT).show();
                progressDialog.dismiss();
            }
